...
Uma aplicação em linha de comando (CLI) desenvolvida em Python para o gerenciamento dinâmico de alunos, notas e médias.                                       
O projeto demonstra conceitos fundamentais de lógica, manipulação de coleções (dicts e lists) e controle de fluxo estruturado. 
